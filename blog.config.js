...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wavebreak', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '沉迷学习', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wavebreak.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'K8s, Cloud', // 网站关键词 英文逗号隔开
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://wavebreak.vercel.app/', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/wavebreake/imagehosting/main/1.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
